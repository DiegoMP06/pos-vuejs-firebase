...
<template>
    ...
    >
        <img :src="product.image" :alt="`Imagen del producto ${product.name}`" class="h-24 w-24" />

        <div class="space-y-2 flex-auto grid grid-cols-1">
            <h3 class="truncate text-gray-900">
                {{ product.name }}
            </h3>
